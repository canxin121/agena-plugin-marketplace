...
Community and verified Agena plugins distributed through immutable GitHub Releases.
...
```bash
agena plugin sync --registry canxin121/agena-plugin-marketplace
agena plugin search --registry canxin121/agena-plugin-marketplace QUERY
agena plugin install PLUGIN.ID --registry canxin121/agena-plugin-marketplace
```
